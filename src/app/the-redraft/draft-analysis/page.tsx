// app/the-redraft/draft-analysis/page.tsx
...
export default async function DraftAnalysisPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-900 via-cyan-900 to-blue-800 p-4 sm:p-6 md:p-8">
      <div className="max-w-7xl mx-auto">
        {/* Home Button */}
        <div className="mb-4 sm:mb-6">
          <Link
            href="/the-redraft"
            className="inline-flex items-center gap-2 px-4 py-2 bg-blue-800/30 hover:bg-blue-700/40 text-blue-200 rounded-lg transition-all duration-200 backdrop-blur-sm border border-blue-700/50"
          >
            <svg
              className="w-5 h-5"
              fill="none"
