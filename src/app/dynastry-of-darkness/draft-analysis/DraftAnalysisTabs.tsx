    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      {currentSeasonData && (
        <div className="bg-purple-800/30 backdrop-blur-sm rounded-xl border border-purple-600/30 overflow-hidden">
          ...
          {/* Position Filters */}
          <div className="px-4 sm:px-6 py-3 sm:py-4 bg-purple-900/30 border-b border-purple-700/30">
            <div className="flex flex-wrap items-center gap-2">
              <span className="text-purple-200 text-sm font-semibold mr-2">Positions:</span>
              <button
                onClick={toggleAllPositions}
                className="px-3 py-1 text-xs font-semibold rounded bg-purple-700/50 hover:bg-purple-700 text-white transition-colors"
              >
