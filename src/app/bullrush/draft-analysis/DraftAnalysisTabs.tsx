...
export default function DraftAnalysisTabs({ seasonsData }: DraftAnalysisTabsProps) {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      {/* Tabs */}
      <div className="bg-red-800/30 backdrop-blur-sm rounded-xl border border-red-700/50 overflow-hidden">
      ...
      {currentSeasonData && (
        <div className="bg-red-800/30 backdrop-blur-sm rounded-xl border border-red-600/30 overflow-hidden">
          {/* Season Header */}
            ...
            <table className="w-full">
              <thead className="bg-red-900/50">
                <tr className="border-b border-red-700">
                  <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-red-300 uppercase tracking-wider">
                  ...
                  <th className="px-3 sm:px-6 py-3 sm:py-4 text-center text-xs font-semibold text-red-300 uppercase tracking-wider">Pos</th>
                  <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-red-300 uppercase tracking-wider">Drafted By</th>
                  <th className="px-3 sm:px-6 py-3 sm:py-4 text-center text-xs font-semibold text-red-300 uppercase tracking-wider">
              ...
              <tbody className="divide-y divide-red-700/30">
                {sortedPicks.map((pick, index) => {
                  ...
                  return (
                    <tr 
                      key={pick.pickNumber} 
                      className={`hover:bg-red-700/20 transition-colors duration-150 ${
                        index % 2 === 0 ? "bg-red-900/20" : ""
                    ...
                    >
                      ...
                      <td className="px-3 sm:px-6 py-3 sm:py-4 text-center">
                        <span className="text-red-300 text-sm sm:text-base">{pick.position}</span>
                      </td>
                      <td className="px-3 sm:px-6 py-3 sm:py-4">
                        <span className="text-red-200 text-sm sm:text-base">{pick.draftedByName}</span>
                      </td>
                      <td className="px-3 sm:px-6 py-3 sm:py-4 text-center">
          ...
          {/* Legend */}
          <div className="px-4 sm:px-6 py-3 sm:py-4 bg-red-900/20 border-t border-red-700/30">
            <div className="flex flex-wrap gap-3 sm:gap-4 text-xs text-red-200">
      ...
      {seasonsData.length === 0 && (
        <div className="text-center text-red-200 text-lg py-12">
