            ...
            <table className="w-full">
              <thead className="bg-slate-900/50">
                <tr className="border-b border-slate-700">
                  ...
                  <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-slate-400 uppercase tracking-wider">Player</th>
                  <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-semibold text-slate-400 uppercase tracking-wider">Team</th>
                  <th className="px-3 sm:px-6 py-3 sm:py-4 text-center text-xs font-semibold text-slate-400 uppercase tracking-wider hidden sm:table-cell">Season</th>
                  <th className="px-3 sm:px-6 py-3 sm:py-4 text-center text-xs font-semibold text-slate-400 uppercase tracking-wider hidden sm:table-cell">Week</th>
                ...
                {top.map((row, index) => (
                  <tr key={`${row.season}-${row.week}-${row.teamName}-${row.playerId}-${index}`} className="hover:bg-slate-700/30 transition-colors duration-150">
                    <td className="px-3 sm:px-6 py-3 sm:py-4 text-center">
                      <span className="inline-flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-purple-500/20 text-purple-400 font-bold text-xs sm:text-sm">
                        {index + 1}
                      </span>
                    </td>
                    <td className="px-3 sm:px-6 py-3 sm:py-4">
                      <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <span className="text-slate-200 font-bold text-sm sm:text-base">{row.playerName}</span>
                      </div>
                    </td>
                    <td className="px-3 sm:px-6 py-3 sm:py-4 text-slate-300 text-xs sm:text-base">{row.teamName}</td>
                    <td className="px-3 sm:px-6 py-3 sm:py-4 text-center text-slate-300 text-xs sm:text-base hidden sm:table-cell">{row.season}</td>
                    <td className="px-3 sm:px-6 py-3 sm:py-4 text-center text-slate-300 text-xs sm:text-base hidden sm:table-cell">{row.week}</td>
                    <td className="px-3 sm:px-6 py-3 sm:py-4 text-center">
